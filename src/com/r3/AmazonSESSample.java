...
public class AmazonSESSample {
    ...
    static final String FROM = "railroadrisk@gmail.com";   // Replace with your "From" address. This address must be verified.
    static final String TO = "tosiddharthsagar@gmail.com";  // Replace with a "To" address. If your account is still in the 
